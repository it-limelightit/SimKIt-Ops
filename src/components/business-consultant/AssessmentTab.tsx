              ...
              {allReasons.map((reason: string) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-mono font-medium transition-all duration-150 cursor-pointer ${isChecked
          ...
          <div className="flex flex-wrap gap-3 py-1">
            {["PGVCL", "UGVCL", "MGVCL", "Torrent", "DGVCL"].map((board) => {
              ...
              return (
                <label
                  key={board}
                  className={`flex items-center gap-2 cursor-pointer select-none py-2 px-4 rounded-xl border text-xs font-mono font-bold transition-all duration-150 ${isChecked
                      ? "border-lime bg-lime-dim/40 text-lime shadow-sm"
                      : "border-border hover:border-border-bright text-text-secondary bg-surface/30"
                    }`}
                >
                  <input
                    ...
                    className="sr-only"
                  />
                  <span className={`inline-block h-3.5 w-3.5 rounded-full border-2 transition-all flex items-center justify-center ${isChecked ? "border-lime bg-lime" : "border-text-dim"
                    }`}>
            ...
            <div className="space-y-6 pt-4 border-t border-border/60 animate-in fade-in duration-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  ...
                  className={`flex items-center gap-3 p-4 rounded-xl border transition-all cursor-pointer select-none ${data.production_count_meaningful
                ...
                >
                  <div className={`w-4 h-4 rounded border flex items-center justify-center transition-all ${data.production_count_meaningful
                ...
                <div
                  ...
                  className={`flex items-center gap-3 p-4 rounded-xl border transition-all cursor-pointer select-none ${data.vibration_monitoring_relevant
                      ? "border-lime bg-lime-dim/10 text-text-primary shadow-[0_0_12px_rgba(200,255,74,0.05)]"
                      : "border-border/60 bg-surface/20 text-text-secondary hover:border-border-bright"
                    }`}
                >
                  <div className={`w-4 h-4 rounded border flex items-center justify-center transition-all ${data.vibration_monitoring_relevant
                      ? "border-lime bg-lime text-primary-foreground"
                      : "border-text-dim"
                    }`}>
                  ...
                  {["Production", "Utility", "Auxiliary", "Support"].map((type) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 md:flex-none px-4 py-2 text-xs font-semibold rounded-lg transition-all duration-200 cursor-pointer ${isActive
